	...
	<div id="header">
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="#">Cards</a></li>
...
echo "<table cellspacing=3 cellpadding=3><tr><td><td>Card<td>Rarity<td>Owned";

$sth = $dbHandle->query("SELECT * FROM $set");
foreach($sth as $row) {
  $count++;
  echo "<tr><td>$count<td><a href='http://magiccards.info/query?q=" . $row['card_name'] . "'>" . $row['card_name'] . "</a><td>" . $row['rarity'] . "<td>" . $row['owned'];
}
